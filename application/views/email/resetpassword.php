                ...
                <tr>
                    <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                        ...
                        <div style="line-height: 35px">
                            ...
                            Reset password confirmation <span style="color: #5caad2;">./Native</span>
                        ...
                        <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                            <tr>
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    ...
                                    <p style="line-height: 24px;margin-bottom:15px;">
                                        Anda telah melakukan request untuk melakukan reset password pada akun anda.

                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Anda dapat melakukan reset password dengan mengklik link dibawah ini
                                    </p>
                                        ...
                                        <tr>
                                            <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                ...
                                                <div style="line-height: 22px;">
                                                    <a href="<?php echo $link?>" style="color: #ffffff; text-decoration: none;">Klik disini</a>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    <div style="line-height: 24px;">
                                        ...
                                        <span style="color: #333333;">./Native</span>
